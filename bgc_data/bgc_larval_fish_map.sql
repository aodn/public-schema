...
--  TODO: sampledatelocal AT TIME ZONE "UTC" AS "SampleTime_UTC",
      ...
      CASE WHEN lfs.projectname LIKE '%NRS%' THEN sv."CTDSST_degC" ELSE lfs.temperature_c END AS "Temperature_degC",
      CASE WHEN lfs.projectname LIKE '%NRS%' THEN sv."CTDSalinity_psu" ELSE lfs.salinity_psu END AS "Salinity_psu",
