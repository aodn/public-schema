-- Phytoplankton Species biovolume product
...
WITH bgc_phyto_raw_species AS (
    ...
    SELECT trip_code, methods, taxon_name, biovolume_um3l  FROM default_biovolumes
    UNION ALL
    SELECT trip_code, methods, taxon_name, biovolume_um3l  FROM grouped
), regrouped AS (
